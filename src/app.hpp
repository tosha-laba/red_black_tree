 ...
 * 2. Сделать деструкторы для дерева и его узлов
 * 3. Проверить корректность работы дерева, а именно:
 *      3.1: выяснить, почему при добавлении узлов, узлы равные корню могут попасть в левое поддерево
 *      3.2: исправить "NPE" при удалении узлов. Пример данных: ввести 1-15, удалить узел 10
